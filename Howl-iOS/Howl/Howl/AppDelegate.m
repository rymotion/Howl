...
- (void)applicationDidBecomeActive:(UIApplication *)application {
    ...
    // This is going to update the location and make sure the app is ready to go again
}
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Howl" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Howl.sqlite"];
    NSError *error = nil;
